    ...
    <div className='bg-background'>
      <main className="flex flex-col items-center justify-center text-center h-screen">
        <Image
          ...
          height={200}
        />
        <h2 className="text-2xl font-bold text-black mt-6">Cadastro realizado com sucesso!</h2>
        <p className="text-sm font-medium mt-4 max-w-[400px]">
          Agora, você pode escolher e anunciar seu produto para venda ou navegar no nosso marketplace.
        </p>
